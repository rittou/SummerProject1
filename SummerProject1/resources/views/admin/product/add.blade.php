...
@section('maincontent')
  ...
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-files-o"></i> Thêm sản phẩm mới</h3>
      <ol class="breadcrumb">
              ...
              <div class="col-lg-12">
                  <section class="panel">
                      ...
                      <div class="panel-body">
                          <div class="form">
                              <form class="form-validate form-horizontal" enctype="multipart/form-data"  method="post" action="admin/product/add">
                                <input type="hidden" name="_token" value="{{csrf_token('')}}">
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-10">
                                          <input class=" form-control" id="name" name="regular_price" type="number" />
                                      </div>
                                  </div>
                                  <div class="form-group ">
                                      <label class="control-label col-lg-2">Giá sale</label>
                                      <div class="col-lg-10">
                                          <input class=" form-control" id="name" name="sale_price" type="number" />
                                      </div>
                                  </div>
                                  <div class="form-group">
