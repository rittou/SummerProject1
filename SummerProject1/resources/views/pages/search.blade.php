...
@section('content')
  <div class="content">
      <div class="container">
        <div class="wrap-item">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><p class="display-4">Có {{count($product)}} sản phẩm phù hợp với từ khóa <strong>{{$keyword}}</strong></p></li>
          </ol>
          <div class="row">
                ...
                <div class="card-group">
                  <div class="card">
                    ...
                    <div class="card-block">
                      <p class="card-title text-xs-center">{{$p->name}}</p>
                      <div class="row">
                          @if ($p->sale_price > 0)
                          <div class="col-sm-4">
