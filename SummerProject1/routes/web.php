...
Route::get('orderListDetail/{id}','PagesController@getOrderListDetail');
Route::get('orderCancel/{id}','PagesController@getOrderCancel');
...
Route::get('order_complete','PagesController@getOrderComplete')->name('order_complete');
Route::get('order_fail/{id}','PagesController@getOrderFail')->name('order_fail');
